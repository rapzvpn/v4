...
echo -e "${BIWhite} │===========================================│"
echo -e " ${BIWhite}│        ${white}[•1]${NC} Create ssh${NC}${white}                    │"
echo -e " ${BIWhite}│        ${white}[•2]${NC} Create trial${NC}${white}                  │"
echo -e " ${BIWhite}│        ${white}[•3]${NC} Renew ssh${NC}${white}                     │"
echo -e " ${BIWhite}│        ${white}[•4]${NC} Delete ssh${NC}${white}                    │"
echo -e " ${BIWhite}│        ${white}[•5]${NC} Cek user login${NC}${white}                │"
echo -e " ${BIWhite}│        ${white}[•6]${NC} List user${NC}${white}                     │"
echo -e " ${BIWhite}│        ${white}[•7]${NC} Delet ssh expired${NC}${white}             │"
echo -e " ${BIWhite}│        ${white}[•8]${NC} Auto Kill ssh${NC}${white}                 │"
